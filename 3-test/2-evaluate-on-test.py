...
os.environ['THEANO_FLAGS'] = 'floatX=float32,device=cpu,lib.cnmem=0.8,dnn.conv.algo_bwd_filter=deterministic,dnn.conv.algo_bwd_data=deterministic,blas.ldflags=-L/usr/local/lib -lopenblas'             

#-LC:/toolkits/openblas-0.2.14-int32/bin -lopenblas'
import theano
import keras
from unet import *
...
TESTDATAPATH = "/home/akhilesh/ultrasound_segmentation-master/USNS/ResizedData/test/compressed"
...
json_file = open('/home/akhilesh/ultrasound_segmentation-master/unet/2-model/unet_model.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
model = model_from_json(loaded_model_json,{'Maxout2D':Maxout2D})
# load weights into new model
model.load_weights("/home/akhilesh/ultrasound_segmentation-master/unet/2-model/unet_model_weights.h5")
# model.compile(optimizer='adam', loss='binary_crossentropy',loss_weights=[1., 0.01])
print("Loaded model from disk")

Y_pred, Y_pred_88, Y_pred_44, Y_pred_binary = model.predict(X_test[:][:,None,:,:])
...
OUTDIR='/home/akhilesh/ultrasound_segmentation-master/USNS/Predicted/128'
...
np.savez("/home/akhilesh/ultrasound_segmentation-master/USNS/Predicted/128/compressed/128_pred.npz",predicted=Y_pred)
